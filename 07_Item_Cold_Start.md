...
3. [Evaluation Metrics](#3-evaluation-metrics)
   - 3.1 [Author-Side Metrics (作者侧指标)](#31-author-side-metrics)
   - 3.2 [User-Side Metrics (用户侧指标)](#32-user-side-metrics)
   - 3.3 [Content-Side Metrics (内容侧指标)](#33-content-side-metrics)
...
5. [Simple Retrieval Channels for New Items](#5-simple-retrieval-channels-for-new-items)
   - 5.1 [Adapting the Two-Tower Model (改造双塔模型)](#51-adapting-the-two-tower-model)
   - 5.2 [Category & Keyword Retrieval (类目、关键词召回)](#52-category--keyword-retrieval)
6. [Clustering-Based Retrieval (聚类召回)](#6-clustering-based-retrieval)
7. [Look-Alike Retrieval (Look-Alike 召回)](#7-look-alike-retrieval)
8. [Traffic / Flow Control (流量调控)](#8-traffic--flow-control)
