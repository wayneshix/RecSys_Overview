...
2. [Semantic-ID Tokenization (语义 ID 量化)](#2-semantic-id-tokenization)
3. [Generative Retrieval (生成式召回): Autoregressive Decoding over Semantic IDs](#3-generative-retrieval-autoregressive-decoding-over-semantic-ids)
4. [Generative Ranking & End-to-End GR (生成式排序)](#4-generative-ranking--end-to-end-gr)
5. [The Generalization Theory: Memorization vs. Generalization](#5-the-generalization-theory-memorization-vs-generalization)
6. [Trade-offs (权衡): Generalization, Cold-Start, Cost, and Why Naive Swaps Fail](#6-trade-offs-generalization-cold-start-cost-and-why-naive-swaps-fail)
