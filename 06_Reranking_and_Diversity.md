...
9. [Expanded Reading — Recent Advances (2026): Generative & Agentic Re-Ranking](#expanded-reading--recent-advances-2026-generative--agentic-re-ranking)
   - [GR2 — Generative Reasoning Re-Ranker (生成式推理重排)](#gr2--generative-reasoning-re-ranker-生成式推理重排)
   - [RecoWorld — Simulated Environments for Agentic Recommenders (智能体推荐的模拟环境)](#recoworld--simulated-environments-for-agentic-recommenders-智能体推荐的模拟环境)
   - [Self-Evolving Recommendation System — Autonomous Model Optimization with LLM Agents (自进化推荐系统)](#self-evolving-recommendation-system--autonomous-model-optimization-with-llm-agents-自进化推荐系统)
