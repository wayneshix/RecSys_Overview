...
1. [A Framing Spectrum: Three Roles for LLMs in RecSys](#1-a-framing-spectrum-three-roles-for-llms-in-recsys)
   - [1.1 LLM-as-encoder / foundation model (表征 / 基座模型)](#11-llm-as-encoder--foundation-model-表征--基座模型)
   - [1.2 LLM-as-reasoner / reranker (推理器 / 重排)](#12-llm-as-reasoner--reranker-推理器--重排)
   - [1.3 LLM-as-agent (智能体)](#13-llm-as-agent-智能体)
...
2. [Reasoning Re-Rankers in Depth](#2-reasoning-re-rankers-in-depth)
   ...
   - [2.3 Reward hacking (奖励作弊)](#23-reward-hacking-奖励作弊)
...
8. [Pinterest in Practice (2024–2026)](#pinterest-in-practice-20242026)
   - [LLM-as-judge for multi-objective alignment (UPO)](#llm-as-judge-for-multi-objective-alignment-upo)
   - [LLM-as-teacher for search relevance distillation](#llm-as-teacher-for-search-relevance-distillation)
